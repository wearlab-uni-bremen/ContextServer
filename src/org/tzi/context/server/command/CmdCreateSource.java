	...
	public ServerCommandResult processCommand(ServerCommandParameters scp) {
		...
		if(scp.words.length<3) {
			...
			if(ctxId==null || ctxId==-1) {
				...
				Integer srcId = scp.csi.addSource(ctxId, scp.words[2]);
				scr.reply.append(srcId.toString());
			}
		}
		return scr;
	}
